...
CONFIGURATION ={
    "data_filepath": "MLOPS-Working-proj\Mlops-project-Main\experiments\real_data.csv",
    "test_size": 0.2,
    "experiment_name ": "bow_and_tfidf_experiment",
...
dagshub.init(repo_name=CONFIGURATION["dagshub_repository_name"], mlflow= True)
